...
- `feature · todo · · working · process ·` [Status channel: architect emits transitions, orchestrator absorbs them](TODO.md.d/status-channel.md) ~hook-choreography ~cross-repo-inbox
